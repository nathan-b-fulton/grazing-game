...
/***/ "./node_modules/react-zine/index.js":
/*!******************************************!*\
  !*** ./node_modules/react-zine/index.js ***!
  \******************************************/
/*! no static exports found */
...
exports.Connector = exports.unsubscribe = exports.subscribe = exports.publishable = exports.publish = exports.issue = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _zine = __webpack_require__(/*! zine */ "./node_modules/zine/index.js");
...
Object.defineProperty(exports, 'publish', {
  enumerable: true,
  get: function get() {
    return _zine.publish;
  }
});
Object.defineProperty(exports, 'publishable', {
  enumerable: true,
  get: function get() {
    return _zine.publishable;
  }
});
Object.defineProperty(exports, 'subscribe', {
  enumerable: true,
  get: function get() {
    return _zine.subscribe;
  }
});
Object.defineProperty(exports, 'unsubscribe', {
  enumerable: true,
  get: function get() {
    return _zine.unsubscribe;
  }
});
...
var Connector = exports.Connector = function (_React$Component) {
  ...
  function Connector(props) {
    ...
    if ((0, _zine.publishable)(_this.props.source)) {
      (0, _zine.subscribe)(_this.props.source, _this.update);
    } else {
      console.warn("Tried to use Connector to subscribe to an unpublishable source: ", _this.props.source);
    }
    return _this;
  }
  ...
  _createClass(Connector, [{
    ...
    value: function componentWillUnmount() {
      ...
      (0, _zine.unsubscribe)(this.props.source, this.update);
    }
  }, {
    ...
    value: function componentWillUpdate(nextProps) {
      ...
      if (source !== oldSource) {
        (0, _zine.unsubscribe)(oldSource, this.update);
        if ((0, _zine.publishable)(source)) {
          (0, _zine.subscribe)(source, this.update);
        } else {
...
function connect(source, render) {
  return function (props) {
    return _react2.default.createElement(Connector, { source: source, render: render, passProps: props });
  };
};
...
/* harmony import */ var react_zine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-zine */ "./node_modules/react-zine/index.js");
...
function setTurn(turn) {
  if (turn !== simulationState.turn) {
    Object(zine__WEBPACK_IMPORTED_MODULE_3__["issue"])(simulationState, {
      turn
    });
  }
}
...
const GraphView = Object(react_zine__WEBPACK_IMPORTED_MODULE_2__["connect"])(simulationState, ({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("svg", {
    ...
    r: glenRadius,
    fill: `hsl(114, ${Math.round(100 * abundance[turn])}%, 23%)`,
    key: index
